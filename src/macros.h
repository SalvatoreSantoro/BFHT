...
static int __primes[26] = {
    0,        193,      389,       769,       1543,      3079,      6151,       12289,    24593,
    49157,    98317,    196613,    393241,    786433,    1572869,   3145739,    6291469,  12582917,
    25165843, 50331653, 100663319, 201326611, 402653189, 805306457, 1610612741, 1610612742};
...
#else // power of 2 size
    #define HT_MAX_SIZE      (HT_INITIAL_SIZE << HT_SIZE_MAX_GROWINGS)
